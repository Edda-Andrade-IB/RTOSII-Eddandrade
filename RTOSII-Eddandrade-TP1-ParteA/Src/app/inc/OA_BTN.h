...
extern const char *SHORTPRESSEDMsg;
extern const char *LONGPRESSEDMsg;
extern const char *BLOCKEDMsg;
extern const char *UNBLOCKEDMsg;
...
enum Btn_Status {
	NONE, SHORTPRESSED, LONGPRESSED, BLOCKED, UNBLOCKED
};
